    ...
    public partial class Init1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(225)", maxLength: 225, nullable: false),
                    Brand = table.Column<string>(type: "nvarchar(225)", maxLength: 225, nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailRecieves", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetailRecieves_Recieves_RecieveId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailRecieves_RecieveId",
                table: "DetailRecieves",
                column: "RecieveId");
